...
public class UserService {
    ...
    @Transactional
    public void patchUserPassword(String token, UserPasswordRequest passwordRequest, NewPasswordRequest newPasswordRequest) {

        User userInfo = findInfoAndCheckPassword(token, passwordRequest);

        userInfo.setPassword(newPasswordRequest.getNewPassword());
    }
