...
import org.example.fourchak.user.dto.request.NewPasswordRequest;
import org.example.fourchak.user.dto.request.UserPasswordRequest;
import org.example.fourchak.user.dto.request.UsernameAndPhoneRequest;
import org.example.fourchak.user.dto.response.UserInfoResponse;
import org.example.fourchak.user.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<UserInfoResponse> getMyInfo(
        ...
        return new ResponseEntity<>(userService.getUserInfoByToken(token, passwordRequest), HttpStatus.OK);
    }
    ...
    public ResponseEntity<UserInfoResponse> putMyInfo(
        ...
        return new ResponseEntity<>(userService.putUsernameAndPhone(token, request, passwordRequest), HttpStatus.OK);
    }
